...
export const listHistory: Intro[] = [
    {
        ...
        info:'Fique ligado: Leia com atenção as informações abaixo. Será útil para todo o jogo!',
        imgTento: 'images/tenton.png',
        desc1:'Uma observação sobre as direções: No jogo, as referências a norte, sul, leste e oeste são orientadas em direção aos cantos da tela, diferentemente de ficarem alinhadas verticalmente para baixo, como é comum na maioria dos jogos. Isso implica que, quando indicar para seguir em direção ao norte, por exemplo, significa movimentar-se em direção ao canto superior direito da tela. O sul corresponde ao canto inferior esquerdo, leste ao canto inferior direito e oeste ao canto superior esquerdo da tela.'
    }
];